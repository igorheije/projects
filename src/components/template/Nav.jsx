      ...
      <nav className="menu">
          ...
          <Card>
            <Card.Header>
              <Accordion.Toggle variant={props.variant} eventKey="0">
                <Link to="/instrumentos">Instrumentos Matemáticos</Link>
              </Accordion.Toggle>
            </Card.Header>

            <Accordion.Collapse eventKey="0">
              <Accordion.Toggle variant="link" eventKey="1">
                <Link to="/conversor">Conversor de Bases</Link>
              </Accordion.Toggle>
            </Accordion.Collapse>
        ...
        <Accordion defaultActiveKey="1">
          <Card>
            ...
            <Accordion.Collapse eventKey="0">
              <Accordion.Toggle variant="link" eventKey="1">
                <Link to="/jogoVelha">Jogo da Velha</Link>
              </Accordion.Toggle>
            </Accordion.Collapse>

            <Accordion.Collapse eventKey="0">
              <Accordion.Toggle variant="link" eventKey="1">
                <Link to="/forca">Jogo da Forca</Link>
              </Accordion.Toggle>
            </Accordion.Collapse>
          </Card>
        </Accordion>
